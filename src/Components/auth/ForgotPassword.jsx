...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("https://backend-doctor-production.up.railway.app/user/reset-password", {
        email,
        password,
        confirmPassword,
      })
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 max-sm:p-4">
