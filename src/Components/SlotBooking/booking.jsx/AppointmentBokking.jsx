...
// //             <input type="text" placeholder="Your Name" name="name" value={patientDetails.name} onChange={handleInputChange} className="w-full p-3 border border-gray-300 rounded-md" />
// //             <input type="email" placeholder="Your Email" name="email" value={patientDetails.email} onChange={handleInputChange} className="w-full p-3 border border-gray-300 rounded-md" />
// //             <input type="tel" placeholder="Your Phone" name="phone" value={patientDetails.phone} onChange={handleInputChange} className="w-full p-3 border border-gray-300 rounded-md" />
// //             <input type="text" placeholder="Your Gender" name="gender" value={patientDetails.gender} onChange={handleInputChange} className="w-full p-3 border border-gray-300 rounded-md" />
// //             <input type="number" placeholder="Your Age" name="age" value={patientDetails.age} onChange={handleInputChange} className="w-full p-3 border border-gray-300 rounded-md" />
// //           </div>
// //           <button onClick={handleBooking} className="w-full mt-6 p-3 bg-blue-500 text-white font-semibold rounded-md hover:bg-blue-600">
// //             Proceed to Payment
// //           </button>
// //         </div>
...
// //                 <button key={index} onClick={() => setSelectedSlot(slot)} className={`w-full p-3 border border-gray-300 rounded-md ${selectedSlot === slot ? 'bg-blue-500 text-white' : 'bg-white text-gray-700'}`}>
// //                   {slot}
// //                 </button>
// //               ))
// //             ) : (
...
//                     <IoIosStar />
//                     <IoIosStarHalf />
//                     <p className="text-sm text-gray-600">({doctor.feedback} Reviews)</p>
//                   </div>
...
//         const options = {
//           key: "rzp_test_1xjRZU43gpPuYd", // Replace with your Razorpay key
//           amount: paymentOptions.amount,
//           currency: paymentOptions.currency,
//           name: "Appointment Booking",
//           description: "Book an appointment with doctor",
  ...
  useEffect(() => {
    if (doctorId || date) {
      axios
        ...
        .catch((error) => {
          console.error("Error fetching slots:", error);
          toast.error("Error fetching available slots. Please try again later."); // Show error toast
        });
    }
    fetchDoctorDetails();
  }, [doctorId, date]);
                ...
                {slots && slots.length > 0 ? (
                  slots.map((slot, index) => (
                    <button
                      ...
                      disabled={slots.indexOf(slot) < 0} // Disable booked slots
                    >
                      {slot}
                    </button>
                  ))
